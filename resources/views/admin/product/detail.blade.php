                ...
                <div class="row gx-lg-5">
                    ...
                    <div class="col-xl-8">
                        <div class="mt-xl-0 mt-5">
                            ...
                            <div class="mt-4 text-muted">
                                <form action="" id="input-cart2_{{$id}}" method="post">
                            ...
                            <div class="mt-4 text-muted">
                                ...
                                @endif
                                <form action="{{route('cart.store')}}" id="input-cart_{{$id}}" method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$showDetail->id}}">
                                    <input type="hidden" name="quantity" id="demo2_{{$id}}" value="" required>
                                </form>
                            </div>
