                        ...
                        <div class="mt-xl-0 mt-5">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <div>
                                        <a onclick="event.preventDefault(); document.getElementById('input-cart_{{$showDetail->id}}').submit();" class="card-link link-success">Add to Cart <i class="las la-shopping-cart align-middle ms-1 lh-1"></i></a>

                                        <form action="{{route('cart.store')}}" id="input-cart_{{$showDetail->id}}" method="POST" style="display: none;">
                                            <input type="hidden" name="id" value="{{$showDetail->id}}">
                                            <input type="hidden" name="price" value="{{$showDetail->price}}">
                                            @csrf
                                        </form>
                                    </div>
                                </div>
