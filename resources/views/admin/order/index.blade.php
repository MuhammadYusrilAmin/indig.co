                        ...
                        <table class="table table-nowrap align-middle" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2101</a></td>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                <a href="{{ url('orders/detail') }}" class="text-primary d-inline-block">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2102</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2103</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2104</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2105</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2106</a></td>
                                    <td class="customer_name">James Price</td>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                <a href="{{ url('orders/detail') }}" data-bs-toggle="modal" class="text-primary d-inline-block">
                                                    <i class="ri-eye-fill fs-16"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2107</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2108</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2109</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2110</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2111</a></td>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ url('orders/detail') }}" class="fw-medium link-primary">#VZ2112</a></td>
                                    <td class="customer_name">Alexis Clarke</td>
