            ...
            <div class="card-header  border-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ url('cart') }}" type="button" class="btn btn-primary add-btn"><i class="las la-shopping-cart align-middle me-1"></i> Add Order</a>
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-3 Pickups" data-bs-toggle="tab" id="Pickups" href="#pickups" role="tab" aria-selected="false">
                                <i class="ri-truck-line me-1 align-bottom"></i> Pickups <span class="badge bg-secondary align-middle ms-1">{{ count($datas->where('status', 'Pickups')) }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <table class="table table-nowrap align-middle" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                @foreach ($datas as $data) <tr>
                                    ...
                                    <td class="status">
                                        <span class="badge {{ $data->status == 'Pending' ? 'badge-soft-warning' : ($data->status == 'Inprogress' ? 'badge-soft-secondary' : ($data->status == 'Delivered' ? 'badge-soft-success' : ($data->status == 'Pickups' ? 'badge-soft-info' : ($data->status == 'Return' ? 'badge-soft-primary' : 'badge-soft-danger')))) }} text-uppercase">{{ $data->status }}</span>
                                    </td>
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                <a href="{{ url('orders/'.$data->id) }}" class="text-primary d-inline-block">
