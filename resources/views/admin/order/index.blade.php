                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-3 Delivered" data-bs-toggle="tab" id="Delivered" href="#delivered" role="tab" aria-selected="false">
                                ...
                                @if (count($datas->where('user_id', Auth::user()->id)->where('status', 'Delivered')) != 0)
                                <span class="badge bg-secondary align-middle ms-1">{{ count($datas->where('user_id', Auth::user()->id)->where('status', 'Delivered')) }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="customer_name">
                                        ...
                                        @if ($data->status == 'Received' && $data->items[0]->rating_id == null)
                                        ...
                                        @elseif ($data->status == 'Received' && $data->items[0]->rating_id != null)
                                        <button type="button" class="btn btn-light btn-sm">
                                            <i class="lab las la-star text-warning"></i>
                                            {{ $data->items[0]->rating->rating }}
                                        </button>
                                        @else
