...
<div class="row mb-5 pb-4">
    ...
    <div class="col">
        <div class="card">
            <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/products/img-2.png') }}" alt="Card image cap">
            <div class="card-body">
    ...
    <div class="col">
        <div class="card">
            <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/products/img-3.png') }}" alt="Card image cap">
            <div class="card-body">
    ...
    <div class="col">
        <div class="card">
            <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/products/img-4.png') }}" alt="Card image cap">
            <div class="card-body">
    ...
    <div class="col">
        <div class="card">
            <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/products/img-5.png') }}" alt="Card image cap">
            <div class="card-body">
