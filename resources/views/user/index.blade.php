    ...
    <div class="col">
        <div class="card" style="height: 350px;">
            ...
            <div class="card-footer">
                <a href="{{url('detail_products?id='.$product->id)}}" class="btn btn-transparent card-link link-secondary">
                    See More <i class="ri-arrow-right-s-line align-middle"></i>
                </a>
                <button onclick="event.preventDefault(); document.getElementById('input-cart_{{$product->id}}').submit();" class="btn btn-transparent card-link link-success">
