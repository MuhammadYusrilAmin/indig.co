...
<div class="d-flex">
    ...
    <div class="dropdown d-inline-block">
        ...
        <div class="dropdown-menu dropdown-menu-end pt-0">
            ...
            <a class="dropdown-item d-flex align-items-center" href="#"><i class="mdi mdi-cog-outline text-muted font-size-16 align-middle me-1"></i><span class="align-middle">@lang('translation.Settings')</span>
                <span_class="badge_badge-soft-success_ms-auto">@lang('translation.New')</span_class=>
            </a>
