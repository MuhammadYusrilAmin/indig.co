...
<head>
    ...
    <!-- Layout config Js -->
    <script src="<?php echo e(URL::asset('assets/js/layout.js')); ?>">
    </script>
    <!-- Bootstrap Css -->
...
<body>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img id="header-lang-img" src="<?php echo e(URL::asset('assets/images/flags/us.svg')); ?>" alt="Header Language" height="20" class="rounded">
                            </button>
    ...
    <!-- JAVASCRIPT -->
    <script src="<?php echo e(URL::asset('assets/libs/bootstrap/js/bootstrap.bundle.min.js')); ?>">
    </script>
    ...
    <script src="<?php echo e(URL::asset('assets/js/pages/plugins/lord-icon-2.1.0.js')); ?>"></script>
...
</html><?php /**PATH D:\KMIPN PROJECT\indigco 2\resources\views/detail.blade.php ENDPATH**/ ?>