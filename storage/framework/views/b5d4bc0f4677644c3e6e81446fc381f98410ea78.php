        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h5 class="card-title flex-grow-1 mb-0">Order <?php echo e($show->id_transaction); ?></h5>
                                ...
                                <td colspan="2" class="fw-medium p-0">
                                    <table class="table table-borderless mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Discount :</td>
                                                <td class="text-end">-<?php echo e("Rp" . number_format(0, 2, ",", ".")); ?></td>
                                            </tr>
                                            <tr>
            ...
            <div class="card-body">
                <ul class="list-unstyled mb-0 vstack gap-3">
                    <li>
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(url('images/'.$show->user->avatar)); ?>" alt="" class="avatar-sm rounded">
                            </div>
                            <div class="flex-grow-1 ms-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-unstyled vstack gap-2 fs-13 mb-0">
                    ...
                    <li><?php echo e($show->address->address.', RT '.$show->address->rt.' / RW '.$show->address->rw); ?></li>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="flex-grow-1 ms-2">
                        <h6 class="mb-0"><?php echo e($show->order_id); ?></h6>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-2">
                    <div class="flex-shrink-0">
                    ...
                    <div class="flex-grow-1 ms-2">
                        <h6 class="mb-0"><?php echo e($show->payment_method); ?></h6>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
