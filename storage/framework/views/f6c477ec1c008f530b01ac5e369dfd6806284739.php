                ...
                <div class="table-responsive table-card">
                    <table class="table table-borderless table-nowrap align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="d-flex">
                                    <img src="<?php echo e(URL::asset('assets/images/users/'.$employee->avatar)); ?>" alt="" class="avatar-xs rounded-3 me-2">
                                    <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco7\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>