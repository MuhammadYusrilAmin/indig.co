                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                title="Remove">
                                                <a class="text-secondary d-inline-block remove-item-btn"
                                        ...
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            ...
                                            <li class="list-inline-item remove"
                                                ...
                                                <a data-bs-toggle="modal" href="#deleteRecordModal"
                                                    class="text-secondary d-inline-block remove-item-btn">
                                                    <i class="ri-delete-bin-5-fill fs-16"></i>
                                                </a>
                                            </li>
                                        </ul>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/apps-ecommerce-customers.blade.php ENDPATH**/ ?>