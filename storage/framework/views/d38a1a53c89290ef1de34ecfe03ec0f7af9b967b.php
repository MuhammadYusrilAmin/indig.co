                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="<?php echo e(count($notverified)); ?>">0</span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!-- end card body -->
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="<?php echo e(count($verified)); ?>">0</span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!-- end card body -->
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="<?php echo e(count($rejected)); ?>">0</span></h4>
                                </div>
                            </div>
                        </div>
                    </div><!-- end card body -->
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            ...
                            <li class="list-group-item" data-id="1">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="<?php echo e(URL::asset('assets/images/users/' . $data->avatar)); ?>">
                                        </div>
                                    </div>
                                </div>
                            </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco5\resources\views/super-admin/index.blade.php ENDPATH**/ ?>