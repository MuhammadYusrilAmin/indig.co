                            ...
                            <div class="card-body p-0">
                                <div class="alert alert-primary border-0 rounded-0 m-0 d-flex align-items-center"
                                    ...
                                    <i data-feather="alert-triangle"
                                        class="text-primary me-2 icon-sm"></i>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-soft-primary rounded-circle fs-2">
                ...
                <div class="card-body p-0">
                    <div>
                        <div id="audiences-sessions-country-charts"
                            data-colors='["--vz-info", "--vz-primary"]' class="apex-charts" dir="ltr">
                        </div>
                    </div>
                </div><!-- end cardbody -->
            </div><!-- end card -->
                        ...
                        <table
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/themesbrand/skote-25867</a>
                                    </td>
                                    <td>99</td>
                                    <td>25.3%</td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/dashonic/chat-24518</a>
                                    </td>
                                    <td>86</td>
                                    <td>22.7%</td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/skote/timeline-27391</a>
                                    </td>
                                    <td>64</td>
                                    <td>18.7%</td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/themesbrand/minia-26441</a>
                                    </td>
                                    <td>53</td>
                                    <td>14.2%</td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/dashon/dashboard-29873</a>
                                    </td>
                                    <td>33</td>
                                    <td>12.6%</td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/doot/chats-29964</a>
                                    </td>
                                    <td>20</td>
                                    <td>10.9%</td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                                        <a href="javascript:void(0);"
                                            class="link-secondary">/minton/pages-29739</a>
                                    </td>
                                    <td>10</td>
                                    <td>07.3%</td>
                                </tr><!-- end -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/dashboard-analytics.blade.php ENDPATH**/ ?>