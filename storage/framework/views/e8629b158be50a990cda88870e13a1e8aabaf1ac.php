        ...
        <div class="card" id="customerList">
            <div class="card-header border-bottom-dashed">
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Customer List <span class="badge bg-secondary align-middle ms-1"><?php echo e(count($datas)); ?></span></h5>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco 2\resources\views/admin/employee/index.blade.php ENDPATH**/ ?>