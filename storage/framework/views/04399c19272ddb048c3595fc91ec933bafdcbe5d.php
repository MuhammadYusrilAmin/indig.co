                        ...
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><a
                                        href="apps-tasks-details" class="link-secondary">Profile
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a
                                            href="apps-tasks-details" class="link-secondary">Velzon
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a
                                            href="apps-tasks-details" class="link-secondary">Admin
                                            Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a
                                            ...
                                            class="link-secondary">Marketing & Sales</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="link-secondary">Brand Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="link-secondary">Change Old App Icon</a></h6>
            ...
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                    <h6 class="fs-14 text-uppercase fw-semibold mb-0">In Reviews <small
                            class="badge bg-success align-bottom ms-1">3</small></h6>
                </div>
                <div class="flex-shrink-0">
                    <div class="dropdown card-header-dropdown">
                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                ...
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="link-secondary">Create Product Animations</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="link-secondary">Product Features Analysis</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="link-secondary">Create a Graph of Sketch</a></h6>
                ...
                <div id="completed-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><a
                                        href="apps-tasks-details" class="link-secondary">Create a
                            ...
                            <div class="mb-3">
                                <div class="d-flex mb-1">
                                    <div class="flex-grow-1">
                                        <h6 class="text-muted mb-0"><span
                                                class="text-secondary">35%</span> of 100%</h6>
                                    </div>
                                    <div class="flex-shrink-0">
                ...
                <div id="new-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="link-secondary">Banner Design for FB & Twitter</a></h6>
                            <div class="tasks-img rounded"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/apps-tasks-kanban.blade.php ENDPATH**/ ?>