            ...
            <form class="needs-validation" novalidate>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                        ...
                        <a href="javascript:void(0);" class="btn btn-soft-primary"><i class="ri-send-plane-fill align-bottom me-1"></i> Send Invoice</a>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/apps-invoices-create.blade.php ENDPATH**/ ?>