                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('assets/images/companies/'.$data->avatar)); ?>" alt="" width="60" class="rounded" />
                                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card border">
                                    <div class="card-body">
                                        <div class="d-sm-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('assets/images/companies/'.$data->avatar)); ?>" alt="" width="80" class="rounded-1" />
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco7\resources\views/pages-search-results.blade.php ENDPATH**/ ?>