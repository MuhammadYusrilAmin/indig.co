...
<?php $__env->slot('title'); ?> Data Produk <?php $__env->endSlot(); ?>
    ...
    <div class="card-header border-0">
        <div class="row g-4">
            <div class="col-sm-auto">
                <div>
                    <a href="<?php echo e(route('products.create')); ?>" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Tambah Produk</a>
                </div>
            </div>
            <div class="col-sm">
        ...
        <div class="row align-items-center">
            <div class="col">
                <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#productnav-all" role="tab">Semua <span class="badge badge-soft-danger align-middle rounded-pill ms-1"><?php echo e(count($datas)); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <?php $publish = \App\Models\Product::where('status', 'Published')->orderBy('created_at', 'DESC')->get(); ?>
                        <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#productnav-published" role="tab">Diterbitkan <span class="badge badge-soft-danger align-middle rounded-pill ms-1"><?php echo e(count($publish)); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco7\resources\views/admin/product/index.blade.php ENDPATH**/ ?>