...
<?php for($a = 0; $a < count($key['costs']); $a++): ?> <script type="text/javascript">
    ...
    <?php for($a = 0; $a < count($key['costs']); $a++): ?> <script type="text/javascript">
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco5\resources\views/user/transaction/checkout.blade.php ENDPATH**/ ?>