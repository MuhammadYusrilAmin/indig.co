                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form>
                                    ...
                                    <div class="mb-2 mt-4">
                                        <a href="<?php echo e(url('/')); ?>" class="btn btn-success w-100">Unlock</a>
                                    </div>
                                </form><!-- end form -->
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco 2\resources\views/profile/lockscreen.blade.php ENDPATH**/ ?>