...
<div class="row mb-3">
    <div class="col-xl-8">
        ...
        <div class="text-end mb-4">
            <a href="<?php echo e(url('checkout')); ?>" class="btn btn-success btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout</a>
        </div>
    </div>
    <!-- end col -->
