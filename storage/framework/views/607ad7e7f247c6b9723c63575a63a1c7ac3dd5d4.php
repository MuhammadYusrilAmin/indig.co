                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0 pb-3">
                                <div id="Market_chart"
                                    data-colors='["--vz-success-rgb, 0.75", "--vz-danger-rgb, 0.75"]'
                                    class="apex-charts" dir="ltr"></div>
                            </div><!-- end cardbody -->
                        </div><!-- end card -->
                    </div><!-- end col -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/dashboard-crypto.blade.php ENDPATH**/ ?>