                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-check card-radio">
                                            ...
                                            <label class="form-check-label" for="shippingAddress_<?php echo e($address->id); ?>">
                                                <span class="mb-4 fw-semibold d-block text-muted text-uppercase"><?php echo e($address->location); ?> , <?php echo e($address->regencies_id); ?></span>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <?php for($a = 0; $a < count($key['costs']); $a++): ?> <div class="col-lg-6">
                                            ...
                                            <div class="form-check card-radio">
                                                <input id="shippingMethod_<?php echo e($key['costs'][$a]['service']); ?>" value="<?php echo e($key['costs'][$a]['cost'][0]['value']); ?>" name="shippingMethod" type="radio" checked class="form-check-input">
                                            ...
                                            <?php else: ?>
                                            <div class="form-check card-radio">
                                                <input id="shippingMethod_<?php echo e($key['costs'][$a]['service']); ?>" value="<?php echo e($key['costs'][$a]['cost'][0]['value']); ?>" name="shippingMethod" type="radio" class="form-check-input">
                                                <label class="form-check-label" for="shippingMethod_<?php echo e($key['costs'][$a]['service']); ?>">
                                                    <span class="fs-16 float-end mt-2 text-wrap d-block fw-semibold"><?php echo e("Rp " . number_format($key['costs'][$a]['cost'][0]['value'], 2, ",", ".")); ?></span>
                                                    <span class="fs-14 mb-1 text-wrap d-block">JNE <?php echo e($key['costs'][$a]['service']); ?></span>
                                                    <span class="text-muted fw-normal text-wrap d-block"><?php echo e($key['costs'][$a]['description']); ?></span>
...
<?php for($a = 0; $a < count($key['costs']); $a++): ?> <script type="text/javascript">
    ...
    <?php for($a = 0; $a < count($key['costs']); $a++): ?> <script type="text/javascript">
        ...
        var data=$(this).val();
        var totalPayment = parseInt(<?= $subTotal ?>) + parseInt(data) + parseInt(7000) - parseInt(<?= $discount ?>);
        $('#shipping-charge').html(formatCurrency(data));
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco3\resources\views/admin/transaction/checkout.blade.php ENDPATH**/ ?>