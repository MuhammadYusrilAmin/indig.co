    ...
    <div class="col">
        <div class="card" style="height: 350px;">
            ...
            <div class="card-footer">
                <a href="<?php echo e(url('detail_products?id='.$product->id)); ?>" class="card-link link-secondary">See More <i class="ri-arrow-right-s-line align-middle"></i>
                </a>
                <button onclick="event.preventDefault(); document.getElementById('input-cart_<?php echo e($product->id); ?>').submit();" class="btn btn-transparent card-link link-success">Add to Cart <i class="las la-shopping-cart align-middle"></i>
                </button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco6\resources\views/user/index.blade.php ENDPATH**/ ?>