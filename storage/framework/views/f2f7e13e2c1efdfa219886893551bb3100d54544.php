<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.list-view'); ?> <?php $__env->stopSection(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <span class="badge bg-priamry me-1">338</span> <span class="text-muted"> Unpaid by clients</span>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-light rounded fs-3">
                            ...
                            <table class="table align-middle table-nowrap" id="invoiceTable">
                                ...
                                <tbody class="list form-check-all">
                                    <tr >
                                        ...
                                        <td class="id"><a href="apps-invoices-details" class="fw-medium link-secondary">#VL25000351</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Diana Kohler
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000352</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                James Morris
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000353</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Dawn Koh
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000354</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Tonya Noble
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000355</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                David Nichols
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000356</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-7.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Joseph Payten
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000357</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);"
                                                class="fw-medium link-secondary">#VL25000358</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 avatar-xs me-2">
                                                    <div class="avatar-title bg-soft-success text-success rounded-circle fs-13">
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000359</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Ryan Cowie
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000360</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Christina Maier
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000361</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-xs rounded-circle me-2" />
                                                Jennifer Winkel
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="javascript:void(0);" class="fw-medium link-secondary">#VL25000362</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 avatar-xs me-2">
                                                    <div class="avatar-title bg-soft-success text-success rounded-circle fs-13">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/apps-invoices-list.blade.php ENDPATH**/ ?>