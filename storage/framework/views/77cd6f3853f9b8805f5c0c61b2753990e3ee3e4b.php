                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 fs-15">
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">Photoshop</a>
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">illustrator</a>
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">HTML</a>
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">CSS</a>
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">Javascript</a>
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">Php</a>
                                        <a href="javascript:void(0);"
                                            class="badge badge-soft-secondary">Python</a>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\saas\resources\views/pages-profile.blade.php ENDPATH**/ ?>