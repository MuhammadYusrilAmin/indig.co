...
unset($__errorArgs, $__bag); ?>" name="nik" value="<?php echo e(old('nik')); ?>" id="nik" placeholder="Enter nik" required>
                                                <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="since_year" value="<?php echo e(old('since_year')); ?>" id="since_year" placeholder="Enter since year" required>
...
unset($__errorArgs, $__bag); ?>" name="owner_name" value="<?php echo e(old('owner_name')); ?>" id="owner_name" placeholder="Enter owner name" required>
...
unset($__errorArgs, $__bag); ?>" name="company_name" value="<?php echo e(old('company_name')); ?>" id="company_name" placeholder="Enter company name" required>
...
unset($__errorArgs, $__bag); ?>" name="website" value="<?php echo e(old('website')); ?>" id="website" placeholder="Enter url website" required>
...
unset($__errorArgs, $__bag); ?>" name="contact" value="<?php echo e(old('contact')); ?>" id="contact" placeholder="Enter contact" required>
...
unset($__errorArgs, $__bag); ?>" name="fax" value="<?php echo e(old('fax')); ?>" id="fax" placeholder="Enter fax" required>
                                                <?php $__errorArgs = ['fax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="logo" value="<?php echo e(old('logo')); ?>" id="logo" placeholder="Upload logo" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KMIPN PROJECT\indigco4\resources\views/auth/register-cooperative.blade.php ENDPATH**/ ?>